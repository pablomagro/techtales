...
### [EBS volumes deleted](https://docs.amazonaws.cn/en_us/AWSEC2/latest/WindowsGuide/ebs-deleting-volume.html) with the `TerminateInstances` API call continue to show for some time on AWS Config console
